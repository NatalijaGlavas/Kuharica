...
{ // sgo je instanca klase SwaggerGenOptions
  // čitati https://devintxcontent.blob.core.windows.net/showcontent/Speaker%20Presentations%20Fall%202017/Web%20API%20Best%20Practices.pdf
    var o = new Microsoft.OpenApi.Models.OpenApiInfo()
    {
        ...
        {
            Email = "natalija-glavas@hotmail.com",
            Name = "Natalija Glavaš"
        },
        Description = "Ovo je dokumentacija za Kuharica API",
        License = new Microsoft.OpenApi.Models.OpenApiLicense()
        {
            Name = "Kuharica licenca"
        }
    };
    sgo.SwaggerDoc("v1", o);
...
builder.Services.AddDbContext<KuharicaContext>(o =>
    o.UseSqlServer(builder.Configuration.GetConnectionString(name: "KuharicaContext")));
